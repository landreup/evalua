...
# Alumnes
url(r'^alumnes/?$', 'listadoAlumnos', {'rol': "coordinador"}),
url(r'^alumnes/nou$', 'gestionAlumno'),
url(r'^alumnes/(?P<alumnoid>\w+)//?editar?/?','gestionAlumno', {'accion': "editar"}),
url(r'^(?P<profesorid>\w+)/alumnes$', 'listadoAlumnos', {'rol': 'coordinador-tutor'}),

# Cursos
url(r'^cursos/?$', 'listadoCursos'),
url(r'^cursos/nou/?$', 'nuevoCurso'),
url(r'^cursos/nou/confirmat/?$', 'nuevoCurso', {'confirma': "si"}),
)